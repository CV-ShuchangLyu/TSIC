_base_ = [
    '../../configs/_base_/models/upernet_vit-b16_ln_mln.py', '../../configs/_base_/datasets/pascal_voc12_aug.py',
...
work_dir = './experiments/DeeplabV3/voc_SAM_DeeplabV3_KD_results/'
